...
exports.jwkThumbprint = publicKey => {
  const { e, kty, n } = exports.jwk(publicKey);
...
exports.createClient = (params, callback) => {
  ...
  client.get(params.url, (err, res) => {
    ...
    Object.keys(resourceMap).forEach(resource => {
      ...
      const method = resource.replace(/-([a-z])/g, m => m[1].toUpperCase());
...
exports.LETSENCRYPT_URL = "https://acme-v01.api.letsencrypt.org/directory";
